...
import navbar from './components/dist/navbar';
const  App = () =>{
 ...
 return(
    <main>
      ...
      <div onClick={mobile}class="hamburger">
        ...
        {/*Mobile Navbar*/}
        <div id="navbarmobile">
        <ul id="mobile-ul" className="nav-links">
            <NavLink  to='/'  text="Home"/>
      
             <li id="githubl">
                <a id="github" href="https://github.com/FonderElite" className="nav-links" target="_blank" rel="noopener noreferrer">Github</a>
            </li>
            <li id="projectsl" className="nav-links">
              <a id="projects"href="/projects">Projects</a>
              </li>
              <li id="discordlink" className="nav-links">
              <a id="discordhere"href="/projects">Discord</a>
              </li>
